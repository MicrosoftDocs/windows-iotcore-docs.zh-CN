...
---
# <a name="release-notes-for-build-17744"></a>发行说明生成 17744
_生成号 17744。 2018 年 8 月。_
...
某些 USB 键盘和鼠标可能无法在 IoT 核心版上工作。 使用其他键盘或鼠标。 可以在找到的已验证的外围设备列表[此处的文档](https://docs.microsoft.com/windows/iot-core/learn-about-hardware/hardwarecompatlist)。
...
* [添加到图像文件和注册表设置](https://msdn.microsoft.com/library/windows/hardware/mt670641(v=vs.85).aspx)
