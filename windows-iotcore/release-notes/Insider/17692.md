...
---
# <a name="release-notes-for-build-17692"></a>版本17692的发行说明
_内部版本号17692。2018年6月。_
...
`bcdedit /set debug off`例如. 在 "Windows 设备门户/进程/运行命令" 中, "c:\windows\system32\bcdedit/set debug off")
