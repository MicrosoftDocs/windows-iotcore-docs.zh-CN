...
---
# <a name="release-notes-for-build-16257"></a>发行说明生成 16257

_生成号 16257。 2017 年 8 月_
...
* Joule 可能变得不稳定因图形驱动程序问题而 30-60 分钟后。 
* 映像创建可能由于 InstallOemCerts.cmd 命令错误 (13038321) 而失败。 
* 后台任务不显示在应用程序管理器视图中 Windows Device Portal (WDP) (13037606)。 
...
### <a name="for-joule"></a>Joule 为 
#### <a name="firmware-update-required"></a>所需的固件更新 
Intel Joule 需要能够正确加载 Windows IoT Core 的固件更新。 请按照安装过程的详细[此处]( https://developer.microsoft.com/en-us/windows/iot/Docs/GetStarted/joule/GetStartedStep1.htm)Joule 与使用 IoT Core。 
