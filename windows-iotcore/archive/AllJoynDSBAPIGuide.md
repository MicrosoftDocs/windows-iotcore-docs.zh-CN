...
> | Version | 此适配器的软件版本 | AllJoyn About 数据 SW 版本 |
...
> | Version                 | 此设备的软件版本 | AllJoyn About 数据 SW 版本 |
...
> | :-------------------------- | :--------------------------------- | :-------------------------------------------- |
> | 特性                |IAdapterAttributes 的集合    | AllJoyn 属性集（请参阅 IAdapterValue） |
...
每个 ISignal 均作为设备的托管会话信号宣布到 AllJoyn，并包含信号名称。  
必须为 ISignal 实现以下属性
