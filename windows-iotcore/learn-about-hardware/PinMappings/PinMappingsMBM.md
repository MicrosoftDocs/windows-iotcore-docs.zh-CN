...
MinnowBoard Max 具有与 I2C 总线相关的已知问题，这会导致某些 I2C 设备出现通信问题。 通常，I2C 设备会在总线请求期间确认其地址。
...
当前的解决方法是使用 I2C SCK line 插入系列中的100欧姆电阻器，这有助于抑制峰值。 并非所有设备都受影响，因此，仅当遇到总线响应问题时才需要此解决方法。 已知需要此解决方法的一个设备是 HTU21D。
