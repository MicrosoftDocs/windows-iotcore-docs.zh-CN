...
Semtech 的 LoRa®超长范围（100M 到10KM），传播频谱通信技术具有高干扰抗干扰性，并提供一种低成本的解决方案，用于将备有电池的设备连接到传统的网络基础结构。
...
> | SparkFun 三轴加速计突围 - ADXL345 | ARM32、x64、x86 | 高分辨率（13位）（最大为± 16 g）度量的小型、窄、低电源、3轴 MEMS 加速感应。 数字输出数据的格式设置为 16 位的二进制补码，并可通过 SPI（3 线或 4 线）或 I2C 数字接口访问。 |[加速感应示例](https://github.com/Microsoft/Windows-iotcore-samples/tree/master/Samples/Accelerometer) | &#10004; |
