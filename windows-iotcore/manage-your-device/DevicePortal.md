...
![在 ICS 上](../media/DevicePortal/OnboardingAllJoyn.png)
加入到 AllJoyn![载入](../media/DevicePortal/OnboardingICS.png)
...
> [!IMPORTANT]
> Limpet 是 Windows IoT Core 的组成部分。 从10月2018开始, 现在可作为开源 porject [https://github.com/ms-iot/azure-dm-client](https://github.com/ms-iot/azure-dm-client)。
...
4. `HKEY_LOCAL_MACHINE\SYSTEM\ControlSet001\Control\CrashControl\CrashDumpEnabled`验证是否已设置为0x1。
